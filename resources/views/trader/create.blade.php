...
<div class="container">
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708"/>
                    ...
                    @endif
                    <h4 class="card-title mb-1">إضافة تاجر جديد</h4>
                    <p class="mb-2">أدخل البيانات الآتية لإضافة تاجر جديد</p>
                </div>
                <div class="card-body pt-0">
                    <form method="POST" action="{{route('trader.store')}}">
                        @csrf
                        ...
                        <div id="pont1" style="display: none;" class="form-group">
                            ...
                            <input type="number" step=".01" name="cow_pont_price" value="{{old('cow_pont_price')}}" class="form-control @error('cow_pont_price') border-danger @enderror" id="inputSal" placeholder="(إجباري)">
                        ...
                        <div id="pont2" style="display: none;" class="form-group">
                            ...
                            <input type="number" step=".01" name="buffalo_pont_price" value="{{old('buffalo_pont_price')}}" class="form-control @error('buffalo_pont_price') border-danger @enderror" id="inputSal" placeholder="(إجباري)">
                        ...
                        <div id="kilo1" style="display: none;" class="form-group">
                            ...
                            <input type="number" step=".01" name="cow_kilo_price" value="{{old('cow_kilo_price')}}" class="form-control @error('cow_kilo_price') border-danger @enderror" id="inputSal" placeholder="(إجباري)">
                        ...
                        <div id="kilo2" style="display: none;" class="form-group">
                            ...
                            <input type="number" step=".01" name="buffalo_kilo_price" value="{{old('buffalo_kilo_price')}}" class="form-control @error('buffalo_kilo_price') border-danger @enderror" id="inputSal" placeholder="(إجباري)">
