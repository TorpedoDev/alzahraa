...
<div class="row row-sm">
  ...
  <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z"/>
                    ...
                    @endif
                    <h4 class="card-title mg-b-0">  المصاريف اﻻضافية </h4>
                </div>
                ...
                <div id="nav" style="float: left;">
                    ...
                    <a class="btn btn-primary" href="{{route('expense.create')}}" style="margin-right: 20px;">
                        إضافة مصروف 
                    ...
                    <table id="print" class="table table-striped mg-b-0 text-md-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$expense->value}} جنيه</td>
                                <td>
                                    {{\Carbon\Carbon::parse($expense->created_at)->locale('ar')->dayName}}
                                    <br>
                                    {{$expense->created_at}}
                                </td>
                                ...
                                <td>
                                    <div class="row">
                                        <a style="margin-left: 32px;" href="{{ route('expense.edit', $expense->id) }}">
