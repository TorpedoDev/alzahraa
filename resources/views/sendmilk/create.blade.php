        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card  box-shadow-0">
                <div class="card-header">
                    ...
                    @endif
                    <h4 class="card-title mb-1">تسليم لبن لتاجر </h4>
                    <p class="mb-2">أدخل البيانات الآتية لتسليم اللبن لتاجر </p>
                </div>
                <div class="card-body pt-0">
                    <form method="POST" action="{{route('sendmilk.store')}}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="date" name="date" value="{{old('date')}}" class="form-control @error('date') border-danger @enderror" id="inputAddress" placeholder="(اجباري)">
                                    @error('date')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
