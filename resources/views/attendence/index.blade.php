...
<div class="row row-sm">
  ...
  <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z"/>
                    ...
                    @endif
                    <h4 class="card-title mg-b-0">  حضور الموظفين </h4>
                </div>
                ...
                <div id="nav" style="float: left;">
                    ...
                    <a class="btn btn-primary" href="{{route('attendence.create')}}" style="margin-right: 20px;">
                        إضافة حضور 
                ...
                <div class="table-responsive">
                    <table id="print" class="table table-striped mg-b-0 text-md-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">{{$attendences->firstItem() + $index}}</th>
                                <td>{{$attendence->employee->name}}</td>
                                <td>{{$attendence->period == 'am' ? 'صباحي' : 'مسائي'}}</td>
                                <td>
                                {{\Carbon\Carbon::parse($attendence->date)->locale('ar')->dayName}}
                                <br>
                                {{$attendence->date}}
                                ...
                                <td>
                                    <div class="row">
                                        <a style="margin-left: 32px;" href="{{ route('attendence.edit', $attendence->id) }}">
